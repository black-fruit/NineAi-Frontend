...
<template>
  <div class="flex min-w-[75px]  bg-[#e8eaf1] pb-2 dark:bg-[#25272d]  dark:border-[#3a3a40]    border-#efeff5-800 " :class="getMobileLayoutClass" :style="mobileSafeArea">
    ...
    <div style="--tw-shadow-color: #3076fd;" v-for="item in menuList" :key="item.menuName" class="flex justify-center flex-col items-center" :class="isMobile ? 'mt-0' : 'mt-3'" @click="handleClickMenu(item)">
        <div style="--tw-shadow-color: #3076fd;" class="h-12 w-12 border-none cursor-pointer bg-transparent dark:bg-[#25272d] rounded-lg duration-300 flex justify-center items-center" :class="[isActive(item) ? 'border border-[#73a2ff] dark:border-[#73a2ff]' : 'border-transparent']">

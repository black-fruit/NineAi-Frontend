...
<template>
  ...
  <br /><h2 class="text-2xl font-bold mb-5">
          Dall·E 绘画
        </h2>
    <TitleBar des="基于DALL-E的绘画、速度较快、同步等待到结束后在我的绘画中可以看到结果！" :padding="isMobile ? 2 : 20" />
    <div :class="isMobile ? ['px-2'] : ['px-20']">
      ...
      <NInputGroup>
        ...
        <NButton type="primary"  :loading="loading" :disabled="loading" @click="drawImage">
          <template #icon>
            <NIcon>
              <ImagesOutline />
            </NIcon>

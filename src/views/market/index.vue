	...
	<template>
		<div class="bg-[#fff] h-[100vh] overflow-hidden p-4 pr-0 dark:bg-[#18181c] flex flex-col">
			<div class="p-4 flex pr-6 justify-between items-center">
				<div class="font-bold text-xl"><h3 class="text-lg sm:text-2xl font-bold leading-6">AI绘画广场</h3></div>
				<div class="w-[200px] sm:w-[300px] flex justify-between">
					<span class="hidden sm:block"  >尺寸调整</span>
					<div class="flex-1 ml-5">
						<n-slider color="#73a2ff" style="--n-fill-color: #73a2ff;--n-fill-color-hover: #73a2ff;
						--n-dot-border-active: #73a2ff;"  v-model:value="scaleWidth" :step="10" />
					</div>
				</div>
			</div>
